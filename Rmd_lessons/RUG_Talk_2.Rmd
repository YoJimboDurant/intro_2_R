...
- http://rug.cdc.gov/data/AGE_Surveillance_Log.xls
...
## Assignments
Variables are stored in R by _assigning_ them. You can see what variables are in R's memory environment by using the function `objects()`or `ls()`. You can use `<-` or `=` for assignment. 
