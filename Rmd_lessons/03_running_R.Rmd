...
grep("^A.+b", state.name, value = TRUE)    # Start with either A followed by any
                                           # number of characters then b.
...
# Tibbles
Tibbles were an enhancement to `data.frame` objects. The word tibble is jargon for
...
- prints class and top rows by defaults
...
- To add a columns and filter to South region:
```{r}
