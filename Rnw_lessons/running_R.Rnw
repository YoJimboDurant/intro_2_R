...
Example from Agresti (1990), pages 231--237, Penicillin and Rabbits
...
The output for the Mantel-Haenszel exact test is:
...
\begin{frame}[fragile]{Array Example - Mantel-Haenszel test}
Example from Mannocci (2009) Ital J. Public Health. 2009;6(4):338–40 \url{http://ijphjournal.it/article/viewFile/5765/5509}.
<<>>=
mi_array <-
array(c(4,2,62,224,
        9,12,33,390,
